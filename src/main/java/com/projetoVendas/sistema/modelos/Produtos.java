...
public class Produtos implements Serializable {
	...
	public Produtos(Long id, String nome, String codigoBarras, String unidadeMedida, Double estoque, Double precoCusto,
			Double precoVenda, Double lucro, Double margemLucro) {
		super();
		this.id = id;
		this.nome = nome;
